...
/**
 * Base class that represents a row from the 'avatar' table.
 *
 * 
 *
...
abstract class BaseAvatar extends BaseObject  implements Persistent {
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = AvatarPeer::IMAGE;
		}
	...
	public function setGameId($v)
	{
		...
		if ($this->game_id !== $v) {
			$this->game_id = $v;
			$this->modifiedColumns[] = AvatarPeer::GAME_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->game_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 6; // 6 = AvatarPeer::NUM_COLUMNS - AvatarPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setGameId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AvatarPeer::IMAGE)) $criteria->add(AvatarPeer::IMAGE, $this->image);
		if ($this->isColumnModified(AvatarPeer::GAME_ID)) $criteria->add(AvatarPeer::GAME_ID, $this->game_id);
	...
	public function getGame(PropelPDO $con = null)
	{
		if ($this->aGame === null && ($this->game_id !== null)) {
			$this->aGame = GamePeer::retrieveByPk($this->game_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aGame->addAvatars($this);
			 */
		}
		return $this->aGame;
	}
