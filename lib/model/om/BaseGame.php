...
abstract class BaseGame extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array Avatar[] Collection to store aggregation of Avatar objects.
	 */
	protected $collAvatars;

	/**
	 * @var        Criteria The criteria used to select the current contents of collAvatars.
	 */
	private $lastAvatarCriteria = null;
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = GamePeer::IMAGE;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = GamePeer::PRICE;
		}
	...
	public function setDeveloperId($v)
	{
		...
		if ($this->developer_id !== $v) {
			$this->developer_id = $v;
			$this->modifiedColumns[] = GamePeer::DEVELOPER_ID;
		}

		if ($this->aDeveloper !== null && $this->aDeveloper->getId() !== $v) {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->developer_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->game_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->game_name = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			...
			return $startcol + 9; // 9 = GamePeer::NUM_COLUMNS - GamePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aDeveloper !== null && $this->developer_id !== $this->aDeveloper->getId()) {
			$this->aDeveloper = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aDeveloper = null;
			$this->collAvatars = null;
			$this->lastAvatarCriteria = null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getDeveloperId(),
			$keys[5] => $this->getGameId(),
			$keys[6] => $this->getGameName(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setDeveloperId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setGameId($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setGameName($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GamePeer::IMAGE)) $criteria->add(GamePeer::IMAGE, $this->image);
		if ($this->isColumnModified(GamePeer::PRICE)) $criteria->add(GamePeer::PRICE, $this->price);
		if ($this->isColumnModified(GamePeer::DEVELOPER_ID)) $criteria->add(GamePeer::DEVELOPER_ID, $this->developer_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setGameName($this->game_name);
	...
	public function getDeveloper(PropelPDO $con = null)
	{
		if ($this->aDeveloper === null && ($this->developer_id !== null)) {
			$this->aDeveloper = DeveloperPeer::retrieveByPk($this->developer_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aDeveloper->addGames($this);
			 */
		}
	...
	/**
	 * Clears out the collAvatars collection (array).
	 *
	...
	{
		$this->collAvatars = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAvatars collection (array).
	 *
	 * By default this just sets the collAvatars collection to an empty array (like clearcollAvatars());
	 ...
	 * related Avatars from storage. If this Game is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getAvatars($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GamePeer::DATABASE_NAME);
		}
		...
		if ($this->collAvatars === null) {
			if ($this->isNew()) {
			   $this->collAvatars = array();
				...
				$criteria->add(AvatarPeer::GAME_ID, $this->id);
	 ...
	 * @throws     PropelException
	 */
	public function countAvatars(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GamePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collAvatars === null) {
			if ($this->isNew()) {
				...
				$count = AvatarPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addAvatar(Avatar $l)
	{
		...
		if (!in_array($l, $this->collAvatars, true)) { // only add it if the **same** object is not already associated
			array_push($this->collAvatars, $l);
			$l->setGame($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Game has previously been saved, it will retrieve
	 * related Videos from storage. If this Game is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collVideos === null) {
			if ($this->isNew()) {
			   $this->collVideos = array();
				...
				$criteria->add(VideoPeer::GAME_ID, $this->id);
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collAvatars) {
				foreach ((array) $this->collAvatars as $o) {
