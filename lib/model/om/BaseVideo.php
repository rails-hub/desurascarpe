...
abstract class BaseVideo extends BaseObject  implements Persistent {
	...
	public function setGameId($v)
	{
		...
		if ($this->game_id !== $v) {
			$this->game_id = $v;
			$this->modifiedColumns[] = VideoPeer::GAME_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = VideoPeer::NUM_COLUMNS - VideoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoPeer::LINK)) $criteria->add(VideoPeer::LINK, $this->link);
		if ($this->isColumnModified(VideoPeer::GAME_ID)) $criteria->add(VideoPeer::GAME_ID, $this->game_id);
